...
export class AuraUtil {
    constructor() {
        sinon.stub(this, 'addClass').callsFake((component, className) => {
            return component.set(classNameToComponentVar(className), true);
        })
        sinon.stub(this, 'removeClass').callsFake((component, className) => {
            return component.set(classNameToComponentVar(className), false);
        })
        sinon.stub(this, 'hasClass').callsFake((component, className) => {
            return component.get(classNameToComponentVar(className));
        })
        sinon.stub(this, 'toggleClass').callsFake((component, className) => {
